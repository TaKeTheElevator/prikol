...
const STEAMWIDGETS_GROUP_ENDPOINT = 'https://www.steamwidgets.net';
        ...
        req.onreadystatechange = function() {
            if (req.readyState == XMLHttpRequest.DONE) {
                ...
                <div class="steam-group" ` + ((groupBaseStyle.length > 0) ? 'style="' + groupBaseStyle + '"' : '') + `>
                    ...
                    <div class="steam-group-preview ` + ((borderCodeGroupPreview.length > 0) ? borderCodeGroupPreview : '') + `" style="background-image: url('` + json.data.groupAvatar + `'); ` + ((!showImage) ? 'display: none;' : '') + `">
                    </div>
